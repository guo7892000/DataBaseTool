...
namespace Breezee.WorkHelper.DBTool.UI
{
    ...
    {
        private string _OrlFileName = "./Config/Oracle表列默认值清单.xml"; //新增修改的默认值设置
        private string _SQLFileName = "./Config/SQL表列默认值清单.xml"; //新增修改的默认值设置
        ...
        public DefaultValueSet(DataBaseType dbt)
        {
