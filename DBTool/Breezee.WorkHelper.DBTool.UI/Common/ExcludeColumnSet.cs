...
namespace Breezee.WorkHelper.DBTool.UI
{
    ...
    {
        private string _OrlExcludeFileName = "./Config/Oracle生成SQL排除字段清单.xml"; //新增修改查询的排除字段设置
        private string _SQLExcludeFileName = "./Config/SQL生成SQL排除字段清单.xml"; //新增修改查询的排除字段设置
